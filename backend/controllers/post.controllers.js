...
export const uploadPost = async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: `uploadPost Controller error ${error}` })
    }
}
...
export const likePost = async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: `likePost Controller error ${error}` })
    }
}
...
export const savedPost = async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: `savedPost Controller error ${error}` });
    }
};